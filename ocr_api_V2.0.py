...
from PySide2.QtGui import QIcon, Qt, QDesktopServices
...
if __name__ == "__main__":
    ...
    sys.exit(app.exec_())
    # pyinstaller -F -w ocr_api_V2.0.py -i 'logo.ico'
    # pyinstaller -D -w ocr_api_V2.0.py -i 'logo.ico'
    # pyinstaller ocr_api_V2.0.spec
